...
const UserEdit = () => {
  ...
  const handleEditUser = async () => {
    const updatedUserData = { ...userData, dateOfBirth: dob };
    ...
    <View style={styles.container}>
      {isLoading ? (
        ...
        <ScrollView style={{ flex: 1 }}>
          <Text style={{ textAlign: "center", fontSize: 25, fontWeight: "bold", marginBottom: 10, fontFamily: "serif" }}>Edit User Details</Text>
          <View style={{ flexDirection: "row" }}>
            <Text style={{ fontSize: 20, fontFamily: "serif" }}>Username</Text>
          ...
          <View style={{ marginVertical: 5 }}>
            <View style={{ flexDirection: "row", justifyContent: "flex-start" }}>
              <Text style={{ fontSize: 20, fontFamily: "serif" }}>Email</Text>
          ...
          >
            <View>
              <View style={{ flexDirection: "row" }}>
                <Text style={{ fontSize: 20, fontFamily: "serif" }}>Gender</Text>
          ...
          <View style={{ marginVertical: 5 }}>
            <View style={{ flexDirection: "row" }}>
              <Text style={{ fontSize: 20, fontFamily: "serif" }}>Address</Text>
          ...
          <View style={{ marginVertical: 5 }}>
            <View style={{ flexDirection: "row" }}>
              <Text style={{ fontSize: 20, fontFamily: "serif" }}>IsAdmin</Text>
              <MaterialIcons name="admin-panel-settings" size={22} color="black" style={{ left: 5, marginTop: 2 }} />
            </View>
            <View style={{
              borderColor: "#D0D0D0",
              borderWidth: 1,
              ...
              <Picker
                selectedValue={userData.isadmin || ""}
                onValueChange={(itemValue, itemIndex) => setUserData({ ...userData, isadmin: itemValue })}
                mode="dropdown"
              >
          ...
          {/* <View style={{ marginVertical: 5 , borderRadius: 20 }}>
